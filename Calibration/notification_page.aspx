<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="notification_page.aspx.cs" Inherits="Calibration.notification_page" %>
    ...
    <ContentTemplate>
      ...
      <div class="d-flex justify-content-between align-items-end w-100 mb-3">
        <h4 class="m-0 text-lg">
          <i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;ใบแจ้งเตือน</h4>
        <div>
        </div>
      </div>
