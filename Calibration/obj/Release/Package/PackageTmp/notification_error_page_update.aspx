<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="notification_error_page_update.aspx.cs" Inherits="Calibration.notification_error_page_update" %>
    ...
    <ContentTemplate>
      <div class="m-auto">
        ...
        <div class="d-flex justify-content-between align-items-end w-100">
          <div>
            <a href="notification_error_page.aspx" class="btn btn-secondary">
              <i class="bi bi-arrow-return-left"></i>
              &nbsp;BACK
            </a>
          </div>
          <h4 class="m-0 p-2 text-lg card">ใบแจ้งไม่สามารถสอบเทียบได้</h4>
        </div>
