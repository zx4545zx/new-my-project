<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="Calibration.department" %>
  ...
  <asp:UpdatePanel ID="updatepnl" runat="server">
    <ContentTemplate>
      ...
      <div class="d-flex justify-content-between align-items-end w-100">
        <h4 class="m-0 text-lg">แผนก</h4>
        <div>
          <a href="department_new.aspx" class="btn btn-primary">
