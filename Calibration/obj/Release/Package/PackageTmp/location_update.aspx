<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="location_update.aspx.cs" Inherits="Calibration.location_update" %>
    ...
    <ContentTemplate>
      <div class="m-auto">
        ...
        <div class="d-flex justify-content-between align-items-end w-100">
          <div>
            <a href="location.aspx" class="btn btn-secondary">
              <i class="bi bi-arrow-return-left"></i>
              &nbsp;BACK
            </a>
          </div>
          <h4 class="m-0 p-2 text-lg card">สถานที่สอบเทียบ</h4>
        </div>
