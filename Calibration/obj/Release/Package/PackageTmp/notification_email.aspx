<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="notification_email.aspx.cs" Inherits="Calibration.ApprovePage.notification_email" %>
    ...
    <ContentTemplate>
        ...
        <div class="container p-3">
          <div class="card">
            <div class="card-header">
              แจ้งเตือนการสอบเทียบเครื่องมือวัด
            </div>
            <div class="card-body">
      ...
      <script type="text/javascript">
        function Approved(url, id) {
          let result = confirm("คุณต้องการจะแจ้งรับ ใช่หรือไม่?");
          if (result) {
            fetch(url, {
              method: 'POST',
              headers: {
