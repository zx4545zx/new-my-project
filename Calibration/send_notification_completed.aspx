<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="send_notification_completed.aspx.cs" Inherits="Calibration.send_notification_completed" %>
  ...
  <asp:UpdatePanel ID="updatepnl" runat="server">
    <ContentTemplate>
      ...
      <div class="d-flex justify-content-between align-items-end w-100">
        ...
        <h4 class="m-0 p-2 text-lg card">แจ้งเครื่องมือสอบเทียบเสร็จ</h4>
      </div>
      ...
      <div class="card mx-auto w-100" style="background-color: #f0f9ff;">
        <div class="card-body">
          <h5 class="card-title">
            ...
            &nbsp;แจ้งเตือนเครื่องมือสอบเทียบเสร็จ</h5>
              ...
              <div class="col me-4">
                <div class="mb-3 row">
                  ...
                  <input type="text" class="form-control" id="Text2"
                    value="แจ้งเตือนเครื่องมือสอบเทียบเสร็จ" runat="server" required>
                </div>
              </div>
              <div class="col">
                <div class="mb-3 row">
            ...
            <div class="row">
              <div class="col">
                <div>
                  ...
                  ขณะนี้เครื่องมือของท่านได้รับการสอบเทียบเรียบร้อยแล้ว ท่านสามารถนำกลับไปใช้งานได้ที่ห้องสอบเทียบ
                </div>
              </div>
            </div>
              ...
              <div class="col">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="flexDefault"
                    id="flexDefault1" value="แจ้งเตือนการสอบเทียบประจำเดือน" runat="server" checked required>
                  <label class="form-check-label" for="flexRadioDefault1">
                    แจ้งเตือนเครื่องมือสอบเทียบเสร็จ
                  </label>
                </div>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="flexDefault"
