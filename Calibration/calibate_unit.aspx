<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="calibate_unit.aspx.cs" Inherits="Calibration.calibate_unit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  <asp:UpdatePanel ID="updatepnl" runat="server">
    <ContentTemplate>
      <div class="d-flex justify-content-between align-items-end w-100">
        <h4 class="m-0 text-lg">หน่วยสอบเทียบ</h4>
        <div>
          <a href="calibate_unit_new.aspx" class="btn btn-primary">
